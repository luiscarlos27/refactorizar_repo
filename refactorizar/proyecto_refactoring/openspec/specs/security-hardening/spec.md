...
## Purpose
Protección de secretos: claves de API leídas desde variables de entorno con soporte `.env`, plantilla documentada sin secretos reales, y exclusión de `.env` del control de versiones.
## Requirements
